...
{
    public class XReport1Controller : ApiController
    {
        public IHttpActionResult GetXReport1Data(int cashierID,int shiftID,DateTime businessDate,int storeID,int posID)
        {
            try
            {
