...
namespace EasyBizPresenter.Masters
{
    public class CustomerSpecialPriceMasterPresenter
    {
        ...
        public void GetCountryList()
        {
            ...
            if (ResponseData.StatusCode == Enums.OpStatusCode.Success)
            {
                _ICustomerSpecialPriceMasterView.CountryMasterList = ResponseData.CountryMasterList;
            }
        }
        ...
        public void SaveCustomerSpecialPriceMaster()
        {
            try
            {
                if (IsValidForm())
                {
                    ...
                    RequestData.CustomerSpecialPriceMasterRecord.ApplicablePriceListCode = _ICustomerSpecialPriceMasterView.ApplicablePriceListCode;
                    RequestData.CustomerSpecialPriceMasterRecord.CustomerGroupCode = _ICustomerSpecialPriceMasterView.CustomerGroupCode;
        ...
        public void DeleteCustomerSpecialPrice()
        {

            var RequestData = new DeleteCustomerSpecialPriceMasterRequest();
            RequestData.ID = _ICustomerSpecialPriceMasterView.ID;
            var ResponseData = _CustomerSpecialPriceMasterBLL.DeleteCouponMaster(RequestData);
            _ICustomerSpecialPriceMasterView.Message = ResponseData.DisplayMessage;
            _ICustomerSpecialPriceMasterView.ProcessStatus = ResponseData.StatusCode;
        }
        ...
        {
            bool objBool = false;
            if (_ICustomerSpecialPriceMasterView.DateFrom > _ICustomerSpecialPriceMasterView.DateTo)
            {
                _ICustomerSpecialPriceMasterView.Message = "Please give To date is above or from date";
            }
            else if (_ICustomerSpecialPriceMasterView.DiscountValue >= 100)
            {
            ...
            //else if (_ICustomerSpecialPriceMasterView.PromotionName.Trim() == string.Empty)
            //{
            //    _ICustomerSpecialPriceMasterView.Message = "Promotion is missing Please Enter it.";
            //}
            ...
            //}
            else if (_ICustomerSpecialPriceMasterView.StoreCommonUtil == null)
            {
                _ICustomerSpecialPriceMasterView.Message = "store list is empty";
            }
            else if (_ICustomerSpecialPriceMasterView.CategoryCommonUtil == null)
            {
                _ICustomerSpecialPriceMasterView.Message = "Exclusion list 2 is empty";
            }
            else
            {
                objBool = true;
